      ...
      <div id="view-events" className="page-view active flex-grow">
        <div className="max-w-6xl mx-auto px-6 py-16 relative z-10 flex flex-col gap-20">
            ...
            <div className="reveal">
                ...
                <div className="glass-panel overflow-hidden border border-accent/20">
                    <div className="flex flex-col md:flex-row">
                        {/*  Details  */}
                        <div
                            className="w-full md:w-5/12 p-8 md:p-10 border-b md:border-b-0 md:border-r border-white/5 bg-[#161821]/50">
                            <span
                                className="inline-block px-3 py-1 bg-accent/10 text-accent font-bold text-[10px] rounded mb-4 tracking-wider uppercase border border-accent/20">Official
                                Launch</span>
                            <h3 className="text-3xl font-black text-white mb-3 leading-tight tracking-tight">
                                Inauguration Day <br />&amp; Tech Games</h3>
                            <p className="text-gray-400 text-sm mb-6 leading-relaxed">The official launch of the Tech
                                Titans collective. Join us for the premiere followed by intense, time-limited
                                technical games.</p>
                            <div
                                className="flex items-center text-xs font-semibold text-gray-300 gap-2 bg-black/20 p-3 rounded-lg border border-white/5">
                                <i className="fas fa-map-marker-alt text-accent"></i> Venue: Lab 2 (Pending
                                Confirmation)
                            </div>
                        </div>
                        ...
                        <div className="w-full md:w-7/12 p-8 md:p-10">
                            <h4 className="text-xs font-bold text-gray-400 mb-4 uppercase tracking-widest">Game Formats
                            </h4>
            ...
            <div className="max-w-3xl mx-auto w-full reveal">
                <div
                    className="glass-panel p-8 md:p-10 relative overflow-hidden bg-gradient-to-br from-[#161821] to-[#0f1015]">
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); navigate('/auth'); }} className="space-y-5">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div>
                                <label
                                    className="block text-xs font-semibold text-gray-400 mb-2 uppercase tracking-wider">Full
                                    Name</label>
                                <input type="text" required className="input-glass" placeholder="John Doe" />
                            </div>
                            <div>
                                <label
                                    className="block text-xs font-semibold text-gray-400 mb-2 uppercase tracking-wider">Course
                                    / Year</label>
                                <input type="text" required className="input-glass" placeholder="e.g. CS - SY" />
                            </div>
                        </div>
                        <div>
                            <label
                                className="block text-xs font-semibold text-gray-400 mb-2 uppercase tracking-wider">Select
                                Primary Activity</label>
                            <select required className="input-glass appearance-none cursor-pointer">
                                <option value="" disabled selected>-- Choose your challenge --</option>
                        ...
                        <div className="pt-4 text-center">
                            <button type="submit" id="regSubmitBtn"
                                className="btn-keycap w-full py-4 text-sm rounded-lg">Confirm Registration</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div className="reveal">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div
                        className="flex gap-4 group items-center glass-panel p-4 bg-transparent border-dashed border-white/10">
                        <div
                            className="w-16 h-16 rounded bg-[#161821] flex items-center justify-center text-gray-600 group-hover:text-accent transition-colors shrink-0">
                            <i className="fas fa-lock text-xl"></i></div>
                        <div>
