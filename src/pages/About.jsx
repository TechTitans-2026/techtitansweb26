        ...
        <div className="max-w-6xl mx-auto px-6 py-16 relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                ...
                <div className="glass-panel p-8 relative overflow-hidden flex flex-col justify-center border-t-2 border-t-[#ae97d6] reveal"
                    ...
                    <div className="absolute right-4 top-4 text-6xl text-white/5"><i className="fas fa-network-wired"></i>
                    </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 reveal">
                <div className="glass-panel p-6 flex flex-col items-start border-t-2 border-transparent">
                    <div
                        className="w-10 h-10 rounded bg-[#161821] border border-white/10 flex items-center justify-center text-accent mb-4">
                        <i className="fas fa-code"></i></div>
                    <h4 className="text-lg font-bold text-white mb-2">Development</h4>
                    <p className="text-gray-500 text-xs sm:text-sm leading-relaxed">Front-end, Back-end, and Full-stack
                        engineering focused on creating robust digital platforms and custom event software.</p>
                </div>

                <div className="glass-panel p-6 flex flex-col items-start border-t-2 border-transparent">
                    <div
                        className="w-10 h-10 rounded bg-[#161821] border border-white/10 flex items-center justify-center text-cyan-400 mb-4">
                        <i className="fas fa-shield-alt"></i></div>
                    <h4 className="text-lg font-bold text-white mb-2">Cybersecurity</h4>
                    <p className="text-gray-500 text-xs sm:text-sm leading-relaxed">Dedicated to network security
                        analysis, ethical hacking practices, and maintaining secure infrastructure.</p>
                </div>

                <div
                    className="glass-panel p-6 flex flex-col items-start border-t-2 border-transparent sm:col-span-2 md:col-span-1">
                    <div
                        className="w-10 h-10 rounded bg-[#161821] border border-white/10 flex items-center justify-center text-pink-400 mb-4">
                        <i className="fas fa-microchip"></i></div>
                    <h4 className="text-lg font-bold text-white mb-2">IoT &amp; Robotics</h4>
                    <p className="text-gray-500 text-xs sm:text-sm leading-relaxed">Hardware programming, sensor
                        integration, and building automated physical systems for campus challenges.</p>
                </div>
            </div>
        </div>
      </div>
